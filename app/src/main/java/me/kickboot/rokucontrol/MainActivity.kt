...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.wireButtonToRokuCommand(R.id.btnBack, "keypress/Back")
        this.wireButtonToRokuCommand(R.id.btnOk, "keypress/Select")
        this.wireButtonToRokuCommand(R.id.btnUp, "keypress/Up")
        this.wireButtonToRokuCommand(R.id.btnDown, "keypress/Down")
        this.wireButtonToRokuCommand(R.id.btnLeft, "keypress/Left")
        this.wireButtonToRokuCommand(R.id.btnRight, "keypress/Right")
